...
// /data/2.5/weather?q - It should have been in Get method
	...
	public void Weather_API_Test() {
		...
		System.out.println(")))))))))))");
		System.out.println("API Teperature - " +API_temperature);

	}

	@Test(priority = 3)
	public void UI_API_Comparator() {
		Weather.UI_API_Teperature_Comparator(UI_Temperature, API_temperature,Float.parseFloat(prop.getProperty("expected_range")));
	}
